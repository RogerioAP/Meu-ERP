  ...
  if DBGrid1.Fields[0].AsString <> '' then
    ...
    begin
      ...
      try
        ...
        Application.MessageBox('Tipo de Cobrança excluído com sucesso!', 'Concluído',
          MB_OK + MB_ICONINFORMATION);
      except
        on e : Exception do
          Application.MessageBox('Não foi possivel excluir o dado selecionado'#10'porque ele tem relação com outro dado cadastrado!',
