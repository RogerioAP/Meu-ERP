...
type
  TfrmClieFornCadastrados = class(TForm)
    ...
    ADOQuery1NomeRazãoSocial: TWideStringField;
    ADOQuery1ApelidoNomeFantasia: TWideStringField;
    ADOQuery1CPF: TWideStringField;
    ADOQuery1CNPJ: TWideStringField;
    ADOQuery1Telefone: TWideStringField;
    ADOQuery1Celular: TWideStringField;
...
begin
  ...
  begin
    ...
    self.nome_clie_forn := DBGrid1.Fields[1].AsString;
