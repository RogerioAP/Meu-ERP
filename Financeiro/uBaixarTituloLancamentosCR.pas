...
begin
  ...
  begin
    try
      ...
      Application.MessageBox('Recebimento cadastrado com sucesso!', 'Concluído',
      ...
      on e : Exception do
        Application.MessageBox('Não foi possível cadastrar o recebimento do valor!',
...
procedure TfrmBaixarTituloLancamentosCR.VerificarQuitação;
begin
