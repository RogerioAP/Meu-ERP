...
begin
  ...
  begin
    ...
    Application.MessageBox('Grupo de Cliente/Fornecedor excluído com sucesso!',
...
begin
  ...
  self.grupos_cf.Destroy;

  ADOTable1.Active := false;
  ADOTable1.Active := true;
end;

procedure TfrmGruposCFCadastrados.btnVoltarClick(Sender: TObject);
begin
  self.Close;
end;
